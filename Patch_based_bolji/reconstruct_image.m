...
for i = 1:num_target_patches
    ...
    reconstructed_group = reconstruct_group(group, omega2, patch_indices, patch_size);
...
function patches = extract_patch(image, patch_size, stride)
    [n1, n2, ~] = size(image);
    patches = {};
    st = 1;
...
function reconstructed_group = reconstruct_group(group, global_omega, patch_indices, patch_size)
